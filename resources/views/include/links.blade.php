    ...
    <!-- MetisMenu CSS -->
    <link href="{{URL::to('assets/vendor/metisMenu/metisMenu.min.css')}}" rel="stylesheet">
    ...
    <!-- Custom Fonts -->
    <link href="{{URL::to('assets/vendor/font-awesome/css/font-awesome.min.css')}}" rel="stylesheet" type="text/css">
